...
* Comprender el rol de los lenguajes formales en informática.
* Manejar la notación básica de alfabetos, cadenas y lenguajes.
* Aplicar operaciones sobre lenguajes formales.
...
* Definir y analizar gramáticas libres de contexto.
* Construir derivaciones y árboles de derivación.
* Identificar ambigüedad en gramáticas.
* Simplificar gramáticas eliminando símbolos inútiles.
...
* Comprender el modelo de máquina de Turing como formalización de la computación.
* Construir máquinas de Turing para resolver problemas simples.
* Reconocer la noción de lenguaje recursivamente enumerable.
